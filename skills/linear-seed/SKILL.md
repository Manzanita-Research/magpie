...
Seeds live in the backlog until one of three things happens:
...
3. **It composts** — you realize it's not the thing, and archive it. That's fine. Most seeds don't sprout.
...
- **Compost** ones that aren't going anywhere (archive)
